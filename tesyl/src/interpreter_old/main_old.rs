...
use tokens_old::Token; // Shorthanding tokens::TOKENS to just TOKENS

mod lexer_old;
use lexer_old::Lexer; // Must be possible to avoid doing this double stuff

mod parser_old;
use parser_old::Parser;
...
use crate::interpreter_old::Interpreter;
